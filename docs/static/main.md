...
![image-20230730203429678](..\demo\assets\post\ws2812\image-20230730203429678.png)

## LEDC 模块简介

![image-20230730203939070](..\demo\assets\post\ws2812\image-20230730203939070.png)
...
![image-20230324173621026](..\demo\assets\post\ws2812\image-20230324173621026.png)
...
![image-20230324173635697](..\demo\assets\post\ws2812\image-20230324173635697.png)
...
![image-20230730203555869](..\demo\assets\post\ws2812\image-20230730203555869.png)

勾选如下选项

![image-20230730204157518](..\demo\assets\post\ws2812\image-20230730204157518.png)

## 配置 LEDC 参数

参考电路图可知，LEDC 模块连接的是 R128 的 `PA13` 引脚。参考手册可知 MUX 为 7

![image-20230730204335088](..\demo\assets\post\ws2812\image-20230730204335088.png)
...
![image-20230730204505356](..\demo\assets\post\ws2812\image-20230730204505356.png)
...
![image-20230730204634317](..\demo\assets\post\ws2812\image-20230730204634317.png)

## 编译测试

编译后烧录开发板

![image-20230730205555943](..\demo\assets\post\ws2812\image-20230730205555943.png)
...
![image-20230730205753242](..\demo\assets\post\ws2812\image-20230730205753242.png)

即可点亮第一颗 LED

![image-20230730205731463](..\demo\assets\post\ws2812\image-20230730205731463.png)
...
![image-20230730205921963](..\demo\assets\post\ws2812\image-20230730205921963.png)

第二颗 LED 即可点亮绿色

![image-20230730205956129](..\demo\assets\post\ws2812\image-20230730205956129.png)
...
![image-20230730210755413](..\demo\assets\post\ws2812\image-20230730210755413.png)

重新烧录即可实现七彩流水灯

![image-20230730210852640](..\demo\assets\post\ws2812\image-20230730210852640.png)
...
![image-20230729160813223](..\sdk_base\assets\post\wifi\image-20230729160813223.png)
...
![image-20230729161600558](..\sdk_base\assets\post\wifi\image-20230729161600558.png)
...
![image-20230731135830244](..\sdk_module\assets\post\g2d\image-20230731135830244.png)
...
![image-20230731141359278](..\sdk_module\assets\post\mmc\image-20230731141359278.png)
...
![image-20230729175719345](..\dsp\assets\post\dsp_intro\image-20230729175719345.png)

## HIFI5 DSP 框图

![img](..\dsp\assets\post\dsp_intro\tensilica-hifi-idma-256.jpg)
...
![image-20230729230351382](..\dsp\assets\post\dsp_sdk\image-20230729230351382.png)
...
![image-20230729231257263](..\dsp\assets\post\dsp_sdk\image-20230729231257263.png)

然后同意许可文件

![image-20230729231319708](..\dsp\assets\post\dsp_sdk\image-20230729231319708.png)

记得修改下载的地址

![image-20230729231353206](..\dsp\assets\post\dsp_sdk\image-20230729231353206.png)

选择 “否”

![image-20230729231428471](..\dsp\assets\post\dsp_sdk\image-20230729231428471.png)

点击 Next -> Next -> Next -> Next

![image-20230729231445603](..\dsp\assets\post\dsp_sdk\image-20230729231445603.png)

开始安装

![image-20230729231538883](..\dsp\assets\post\dsp_sdk\image-20230729231538883.png)

去掉这个勾

![image-20230729231745728](..\dsp\assets\post\dsp_sdk\image-20230729231745728.png)

选择工作环境

![image-20230729231801562](..\dsp\assets\post\dsp_sdk\image-20230729231801562.png)

初始化中

![image-20230729231813252](..\dsp\assets\post\dsp_sdk\image-20230729231813252.png)

### License 配置

在这里配置 License 即可

![image-20230729231941432](..\dsp\assets\post\dsp_sdk\image-20230729231941432.png)

### 安装 package 包

检查 package

![image-20230729232029991](..\dsp\assets\post\dsp_sdk\image-20230729232029991.png)

没有对应package，我们要手动安装：

![image-20230729232040566](..\dsp\assets\post\dsp_sdk\image-20230729232040566.png)

选择此项

![image-20230729232058105](..\dsp\assets\post\dsp_sdk\image-20230729232058105.png)

找到 package 的 tgz 文件

![image-20230729232105249](..\dsp\assets\post\dsp_sdk\image-20230729232105249.png)

导入即可

![image-20230729232136046](..\dsp\assets\post\dsp_sdk\image-20230729232136046.png)
